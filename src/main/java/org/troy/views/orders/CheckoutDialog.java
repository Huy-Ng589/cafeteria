...
import org.troy.model.CartTableModel;
...
public class CheckoutDialog extends JDialog {
    ...
    public CheckoutDialog(final FoodMenuDialog foodMenuDialog, BillingApp frame, final ItemDaoImpl foodDAO, Users users) {
    ...
    private void deleteItem(){
        ...
        Items temp = (Items) cartTable.getValueAt(row, CartTableModel.OBJECT_COL);
        try {
